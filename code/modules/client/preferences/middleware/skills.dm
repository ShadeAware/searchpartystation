...
/datum/preference_middleware/stats/get_ui_static_data(mob/user)
	...
	for(var/stat_type in GLOB.public_skill_stats)
		var/datum/skill/stat = GLOB.public_skill_stats[stat_type]
...
/datum/preference_middleware/stats/proc/increase_stat(list/params, mob/user)
	...
	var/datum/skill/public_stat = GLOB.public_skill_stats[stat_path]
	if(!public_stat)
		return
