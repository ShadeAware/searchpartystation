GLOBAL_REAL_VAR(starlight_color) = pick(COLOR_SILVER)
GLOBAL_REAL_VAR(space_appearances) = make_space_appearances()

/turf/open/space
	icon = 'icons/turf/space.dmi'
	icon_state = "0"
	name = "\proper the Expanse"
	desc = "The wide open beyond. Somewhere out there is life's cradle -- very, very far from here."
